...
namespace UrFairy {
  public static class ColorExtensions {
    ...
    public static Color R(this Color c, System.Func<float, float> f) {
      c.r = f(c.r);
      return c;
    }

    public static Color G(this Color c, System.Func<float, float> f) {
      c.g = f(c.g);
      return c;
    }

    public static Color B(this Color c, System.Func<float, float> f) {
      c.b = f(c.b);
      return c;
    }

    public static Color A(this Color c, System.Func<float, float> f) {
      c.a = f(c.a);
      return c;
    }
    ...
    public static HSV H(this HSV hsv, System.Func<float, float> f) {
      hsv.h = f(hsv.h);
      return hsv;
    }

    public static HSV S(this HSV hsv, System.Func<float, float> f) {
      hsv.s = f(hsv.s);
      return hsv;
    }

    public static HSV V(this HSV hsv, System.Func<float, float> f) {
      hsv.v = f(hsv.v);
      return hsv;
    }

    public static HSV A(this HSV hsv, System.Func<float, float> f) {
      hsv.a = f(hsv.a);
      return hsv;
    }
  }
